...
<div class ="container" style ="width:400px;margin-top: 100px; ">
	<div class="card">
		...
		<input type="text" name="account" class ="form-control" value="<?php echo $ac; ?>" placeholder="Account NO." ><br>
		<label>New Contact No.:</label><br>
		<input type="text" name="newcontact" class ="form-control" placeholder="Enter New Contact Number"><br>
...
$query="UPDATE registration SET contact='$newcontact' WHERE accountno='$account'";
//$z=amount-'$withdrawal';
...
{  
	...
	?>
	<script> alert('Contact Number updated successfully');
