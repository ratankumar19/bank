...
<div class ="container" style ="width:400px;margin-top: 100px; ">
	<div class="card">
		...
		<input type="text" name="account" class ="form-control" value="<?php echo $ac; ?>" placeholder="Accountno." ><br>
		<label>New Password:</label><br>
		<input type="text" name="newpassword" class ="form-control" placeholder="Enter New Password "><br>
...
$query="UPDATE registration SET password='$newpassword' WHERE accountno='$account'";
//$z=amount-'$withdrawal';
...
{  
	...
	?>
	<script> alert('Transacation successfull');
